...
import ethLogo from '../images/logo/eth-logo.svg';
            ...
            <div className="p-3">
                ...
                <table className="table-auto w-full">
                    ...
                    <tr>
                        ...
                        <th className="p-2 whitespace-nowrap">
                        <div className="font-semibold text-left">Remitente</div>
                        </th>
                        <th className="p-2 whitespace-nowrap">
                        <div className="font-semibold text-left">Receptor</div>
                        </th>
                        <th className="p-2 whitespace-nowrap">
                        ...
                        <th className="p-2 whitespace-nowrap">
                        <div className="font-semibold text-center">Observaciones</div>
                        </th>
                    </tr>
                    </thead>
